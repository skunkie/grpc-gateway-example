...
APIUpdateUserParams contains all the parameters to send to the API endpoint
	...
	for the Api update user operation.
...
// WithDefaults hydrates default values in the Api update user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *APIUpdateUserParams) WithDefaults() *APIUpdateUserParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the Api update user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *APIUpdateUserParams) SetDefaults() {
...
// WithBody adds the body to the Api update user params
func (o *APIUpdateUserParams) WithBody(body APIUpdateUserBody) *APIUpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the Api update user params
func (o *APIUpdateUserParams) SetBody(body APIUpdateUserBody) {
	o.Body = body
}

// WithID adds the id to the Api update user params
func (o *APIUpdateUserParams) WithID(id string) *APIUpdateUserParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the Api update user params
func (o *APIUpdateUserParams) SetID(id string) {
	o.ID = id
}
